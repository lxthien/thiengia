...
class AddUserCommand extends Command
{
    ...
    public function __construct(EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, Validator $validator)
    {
        parent::__construct();
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // See https://symfony.com/doc/current/security.html#hashing-passwords
